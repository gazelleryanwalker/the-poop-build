    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow" key={index}>
                <CardContent className="p-6">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-muted/50">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-sm text-muted-foreground leading-relaxed">
            Important Disclaimer: The case results shown on this page are examples of verdicts and
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary to-accent text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button asChild className="bg-white text-primary hover:bg-white/90 text-lg px-8 py-6" size="lg">
